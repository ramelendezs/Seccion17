...
int c2 = 3;
int d2 = ++c;
// Prefix means increment c before assigning it. WriteLine($"c is {c}, d is {d}");
#endregion
#region operadores aritmeticos binary
int e = 11;
int f = 3;
...
#endregion
#region Ejercicios operadores de asignación
int p1 = 6;
...
// not null, or 30 if authorName is null. int maxLength = authorName?.Length ?? 30; 
// The authorName variable will be "unknown" if authorName was null. 
authorName ??= "unknown";
#endregion
#region operadores bitwise
bool p = true;
bool q = false;
...
Console.WriteLine($"q | {q ^ p,-5} | {q ^ q,-5} ");
#endregion
#region operadore bitwise y shift
Console.WriteLine();
int x = 10;
int y = 6;
